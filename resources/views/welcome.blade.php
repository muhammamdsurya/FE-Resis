...
Kami juga menyediakan berbagai soal latihan dan studi kasus untuk menguji dan memperdalam pemahaman Anda, serta wawasan tentang penerapan ilmu kimia dalam industri. Bersiaplah untuk menghadapi tantangan di sektor kimia dengan percaya diri, menguasai pengetahuan akademis, dan keterampilan praktis yang relevan. Mari bergabung dengan kami dan jadikan setiap pembelajaran sebagai langkah menuju kesuksesan!
                        </p>
                    </div>
                </div>
            ...
            <div class="row gx-0">
                ...
                <div class="col-lg-7 d-flex flex-column justify-content-center" data-aos="fade-up"
                    ...
                    <div class="content">
                        ...
                        <p class="text-center">
                            Menjadi pionir dalam transformasi pembelajaran Kimia Analisis melalui pengalaman belajar interaktif dan aplikatif yang menggunakan teknologi terkini, mempersiapkan siswa untuk menjadi profesional yang kompeten dan inovatif di industri kimia global.
                        </p>

                        <h2 class="text-center">Misi</h2>
                        <div class="d-flex align-items-center misi">
                            <h2 class="me-3">01</h2>
                                <p>Mengembangkan dan menyajikan kurikulum kimia analisis yang inovatif dan terkini untuk memastikan pemahaman mendalam tentang analisis bahan kimia.</p>
                        </div>
                        <div class="d-flex align-items-center misi">
                            <h2 class="me-3">02</h2>
                                <p>Menyediakan platform pembelajaran interaktif yang memungkinkan siswa untuk melakukan eksperimen praktis dan simulasi melalui penggunaan Virtual Lab real-time.</p>
                        </div>
                        <div class="d-flex align-items-center misi">
                            <h2 class="me-3">03</h2>
                                <p>Memberikan akses terbuka dan luas ke sumber belajar, termasuk soal latihan dan studi kasus yang relevan dengan aplikasi industri kimia, untuk meningkatkan keterampilan dan persiapan profesional siswa.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="faq-container">
                        ...
                        <div class="faq-item">
                            ...
                            <div class="faq-content">
                                <p>Kursus kami tersedia ketika siswa/i telah berhasil daftar/registrasi pembuatan akun, Dan sesuaikan dengan kebutuhan belajar yang ingin kalian pelajari sesuai dengan minat.
                                </p>
                            </div>
                            <i class="faq-toggle bi bi-chevron-right"></i>
                        </div><!-- End Faq item-->
                        ...
                        <div class="faq-item">
                            ...
                            <div class="faq-content">
                                <p>Klik menu Login, kemudian klik Daftar/Sign In, lihat notifikasi di email yang kalian daftarkan, lakukan aktivasi akun, dan selamat akun kalian telah berhasil dibuat! Lakukan Login untuk melihat kelas kursus yang telah kami sediakan.</p>
                            </div>
                            <i class="faq-toggle bi bi-chevron-right"></i>
                        </div><!-- End Faq item-->
