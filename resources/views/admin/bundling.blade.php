...
<style>
    ...
    .form-check-input {
        border: 2px solid #000; /* Menambahkan border tebal */
            width: 1.25em; /* Lebar checkbox */
            height: 1.25em; /* Tinggi checkbox */
    }
</style>
    <div class="container-fluid mt-3">
        ...
        <div class="col-6 d-flex justify-content-end gap-2">
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal-bundling">
                Tambah Bundling
            </button>
            ...
            <div class="col-6 col-lg-3 col-md-4 col-sm-6">
                <div class="card" style="width: 100%;">
                    ...
                    <div class="card-body">
                        ...
                        <a href="/detail-kelas" class="btn btn-success">Edit Bundling</a>
                    </div>
                </div>
            </div>
            <div class="col-6 col-lg-3 col-md-4 col-sm-6">
