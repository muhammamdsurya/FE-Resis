                ...
                <div class="row d-flex justify-content-center align-items-center shadow py-3">
                    ...
                    <div class="col-md-5 col-lg-5 ">
                        <form action="{{ route('register')}}" method="POST">
                            ...
                            <!-- Password input -->
                            <div class="form-floating">
                                <input type="password" class="form-control" id="floatingPassword" placeholder="Konfirmasi Password" name="confirm">
                    ...
                    <div class="col-md-5 col-lg-5">
                        <img src="assets/img/logo.png" class="img-fluid d-none d-md-block mx-auto" style="width: 20rem;" alt="Sample image">
                    </div>
                </div>
            </div>
        </div>
