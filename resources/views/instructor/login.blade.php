...
@section('content')
    <style>
        ...
        .login-card {
            ...
            /* Memastikan kartu tetap putih bersih */
        }
                        ...
                        <div class="row g-0 align-items-stretch">
                            ...
                            <div class="col-md-6 p-4 p-lg-5">
                                <form method="POST" action="{{ route('login.instructor') }}">
                                    @csrf
                                    <div class="mb-4">
                                        <h3 class="fw-bold text-dark mb-1" style="letter-spacing: -0.5px;">Instruktur Login
                                        </h3>
                                    ...
                                    @if (session('error'))
                                        <div id="alert-message"
                                            class="alert alert-danger py-2 small border-0 shadow-sm d-flex align-items-center mb-4">
